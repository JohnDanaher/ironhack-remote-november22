...
function renderWhiteSauce() {
  // Iteration 2: add/remove the class "sauce-white" of `<section class="sauce">`
    ...
    if(sauceElement.getAttribute('class').includes('sauce-white')){
...
function renderGlutenFreeCrust() {
 ...
 const crustElement = document.querySelector('.crust');
    ...
    if(crustElement.getAttribute('class').includes('crust-gluten-free')){
...
function renderButtons() {
  ...
  // document.querySelectorAll('.btn').forEach((oneButt) => {
  //   if (oneButt.className.includes('active')) {
  //     onePep.className.remove('active')
  //   }
  // });
}
